...
public class C03_WebElementMethodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(aramaKutusuElementi.getText()); // varsa webelement uzerinde ki yaziyi getirir

        aramaKutusuElementi.sendKeys("Nutella");
        Thread.sleep(2000);
        aramaKutusuElementi.clear();

        System.out.println(aramaKutusuElementi.getSize());  // (1149, 38)
        ...
        System.out.println(aramaKutusuElementi.getLocation()); // (295, 11)

        System.out.println(aramaKutusuElementi.getRect().getDimension()); // (1149, 38)
